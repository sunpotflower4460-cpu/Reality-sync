...
export default function App() {
  ...
  const { experiments, startExperiment, startRevalidation, captureTrial, removeTrial, finish, abandon, deleteExperiment, replaceExperiments } = useExperiments();
